            ...
            <div class="mx-auto">
                ...
                <ul data-aos="fade-up"
                    ...
                    <li><a href="/services.html"
                            class=" text-gray-800 hover:opacity-80 transition-all duration-500">Services</a></li>
                ...
                <div class="border-t md:flex-row flex-col gap-5 border-gray-200 pt-5 flex items-center justify-center mt-8">
                    <span class="text-lg text-gray-500 text-center block">© <span id="copyright"></span> GREENCYCLES All rights reserved</span>
                </div>
            </div>
        </div>
    </footer>
